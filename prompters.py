...
class Prompter(nn.Module):
    def __init__(self, args):
        ...
        self.prompt= nn.Parameter(torch.randn([1, 3, self.prompt_size, self.prompt_size]))
    ...
    def forward(self, x):
        ...
        base[:,:,0:self.prompt_size,0:self.prompt_size]=base[:,:,0:self.prompt_size,0:self.prompt_size]+prompt
