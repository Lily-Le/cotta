...
def load_cfg_fom_args(args,description="Config options."):
    ...
    log_dest = log_dest.replace('.yaml', '.txt')

    # g_pathmgr.mkdirs(cfg.SAVE_DIR)
    args.filename = '{}-{}/{}-{}/N_{}/{}-lr_{}-decay_{}/bsz_{}/trial_{}'. \
        format(args.dataset, cfg.MODEL.ARCH,args.method, args.prompt_size, args.N,
               args.optim, args.learning_rate, args.weight_decay, args.batch_size, args.trial)
    args.save_path = 'output/' + args.filename
